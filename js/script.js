...
//Here I create a regex for the email field to be used for the real time error message as well as form validation
...
//Here is the event listener that will detect whether or not the message should be displayed
...
//Selecting the credit card option by default
pay[1].selected = 'selected';
...
//Creating error messages here so they don't repeat on button click
//Here I make an error indicator for the name field
...
//Error messages for credit card input fields
//Credit card
...
//Error message for the zip code
...
//Error message for the CVV number
